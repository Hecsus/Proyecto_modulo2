...
const productosRoutes = require('./routes/productos.routes');     // Rutas de productos (CRUD y bajo stock)
...
// Archivos públicos (CSS, imágenes, etc.) expuestos bajo /resources
...
// Rutas de productos (CRUD) bajo /productos
app.use('/productos', requireAuth, productosRoutes.router);
// Listado de bajo stock accesible directamente en /bajo-stock
app.use('/', productosRoutes.lowStockRouter);
